...
\item Trenowanie sieci przez około 20 trenowalnych epok. W każdej epoce używana jest taka sama liczba pozytywnych
i negatywnych przykładów.
\item Inkrementacja zmiennej BootsIter = BootsIter+1;
\item Jeśli BootsIter < 6 to idź do (3)
\item Trenowanie sieci przez kolejne 20 epok, ale już dla całego zbioru obazów.
 \end{enumerate}

Przedstawiony wyżej algorytm został zaczerpnięty z [1]. 
